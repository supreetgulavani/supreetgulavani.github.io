...
<div class="card-grid" style="margin-top:32px; max-width:640px;">
  ...
  <a class="nav-card" href="https://linkedin.com/in/supreetgulavani" target="_blank" rel="noopener noreferrer">
    <h3>LinkedIn</h3>
    <p>Connect professionally</p>
  </a>
  <a class="nav-card" href="https://github.com/supreetgulavani" target="_blank" rel="noopener noreferrer">
    <h3>GitHub</h3>
