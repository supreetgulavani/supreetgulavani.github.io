...
<!--   <div class="proj">
    <div class="proj-head"><h3>LLM-based ICL/PDL Generator</h3><span class="status wip">IN PROGRESS</span></div>
 ...
 <!--  <div class="proj">
    ...
    <div class="links"><a href="https://github.com/supreetgulavani" target="_blank">GitHub ↗</a></div>
  </div> -->
...
<!--   <div class="proj">
  ...
  <div class="proj">
    <div class="proj-head"><h3>RL-based Channel Allocation in Cognitive Radio Ad-hoc Networkds</h3></div>
